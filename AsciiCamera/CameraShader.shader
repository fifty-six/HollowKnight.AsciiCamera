...
#include "UnityCG.cginc"
		...
		float4 frag(v2f i) : SV_Target
		{
			...
			if (gray > 0.05f) n = 65600;    // :
			if (gray > 0.1f) n = 145536;		// +
			if (gray > 0.15f) n = 459200;	// =
			if (gray > 0.2f) n = 9507090;	// %
			if (gray > 0.3f) n = 332772;	// *
			if (gray > 0.4f) n = 15252014; // 8
			if (gray > 0.5f) n = 13199452; // @
			if (gray > 0.6f) n = 11512810; // #
			if (gray > 0.95f) n = 15728622; // █
